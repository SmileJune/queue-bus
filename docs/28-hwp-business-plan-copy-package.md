...
| 순서 | 삽입 위치 | 이미지 | 캡션 |
| --- | --- | --- | --- |
| 1 | Ⅰ-1 개발 동기·배경 뒤 | [queuebus-service-flow.png](/Users/yun-iljun/programming/queue-bus/docs/assets/queuebus-service-flow.png) | 좌석예약이 아닌 위치 인증형 정류장 대기 관리 흐름 |
| 2 | Ⅰ-2 필요성 또는 Ⅱ-1 시장성 | [gbis-evening-station-risk.png](/Users/yun-iljun/programming/queue-bus/docs/assets/gbis-evening-station-risk.png) | GBIS 잔여좌석 기반 다음차 안내 필요 구간 |
| 3 | Ⅱ-1 시장성 또는 Ⅳ 기술성 | [gbis-evening-heatmap.png](/Users/yun-iljun/programming/queue-bus/docs/assets/gbis-evening-heatmap.png) | 시간대별 호출 보류·다음차 안내 판단 지표 |
| 4 | Ⅳ 기술성 | [prototype-passenger-checkin.jpg](/Users/yun-iljun/programming/queue-bus/docs/assets/prototype-passenger-checkin.jpg) | 사용자 위치 인증, 대기번호, 호출 보류 화면 |
| 5 | Ⅳ 기술성 또는 Ⅲ 성장성 | [prototype-operator-dashboard.jpg](/Users/yun-iljun/programming/queue-bus/docs/assets/prototype-operator-dashboard.jpg) | 운영자 미탑승 위험 감지 및 정류장 운영 화면 |
| 6 | Ⅳ 기술성 AI 부분 | [prototype-ai-prediction.jpg](/Users/yun-iljun/programming/queue-bus/docs/assets/prototype-ai-prediction.jpg) | SeatFlow AI와 보수 호출 정책 화면 |
| 7 | Ⅳ 기술성 개인정보 보호 부분 | [privacy-data-flow.png](/Users/yun-iljun/programming/queue-bus/docs/assets/privacy-data-flow.png) | 개인 위치 대신 집계 지표 중심 운영 구조 |
...
```text
이미지: /Users/yun-iljun/programming/queue-bus/docs/assets/queuebus-service-flow.png
...
```text
이미지: /Users/yun-iljun/programming/queue-bus/docs/assets/gbis-evening-station-risk.png
...
```text
이미지: /Users/yun-iljun/programming/queue-bus/docs/assets/gbis-evening-heatmap.png
...
```text
이미지: /Users/yun-iljun/programming/queue-bus/docs/assets/prototype-operator-dashboard.jpg
...
```text
이미지: /Users/yun-iljun/programming/queue-bus/docs/assets/prototype-passenger-checkin.jpg
...
```text
이미지: /Users/yun-iljun/programming/queue-bus/docs/assets/prototype-ai-prediction.jpg
...
```text
이미지: /Users/yun-iljun/programming/queue-bus/docs/assets/privacy-data-flow.png
